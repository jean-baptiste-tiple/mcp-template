...
Consult [.claude/conventions/security-patterns.md](.claude/conventions/security-patterns.md) for the full patterns. Load it before writing security-sensitive code.
